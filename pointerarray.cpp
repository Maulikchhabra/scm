...
int main()
{
	int arr[5],i; //array and array element declaration//
	int sum,sub,mul,div,increment,decrement; //operation declaration//
	cout<<"Enter the elements=";
	for(i=0;i<5;i++) //for loop to input array//
	{
		cin>>arr[i];
	}
	cout<<"Elements are="<<endl;
	for(i=0;i<5;i++) //for loop to show the array//
	{
		cout<<arr[i]<<endl;
	}
